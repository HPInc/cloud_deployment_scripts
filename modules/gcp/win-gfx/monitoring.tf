...
resource "google_monitoring_dashboard" "gwin-dashboard" {
  count          = var.gcp_ops_agent_enable ? length(local.instance_info_list) : 0
            ...
            "dataSets": [
              {
                ...
                "timeSeriesQuery": {
                  ...
                  "timeSeriesFilter": {
                    ...
                    "filter": "metric.type=\"compute.googleapis.com/instance/cpu/utilization\" resource.type=\"gce_instance\" resource.labels.instance_id=\"${google_compute_instance.win-gfx[count.index].instance_id}\" "
                  }
                }
              }
            ],
