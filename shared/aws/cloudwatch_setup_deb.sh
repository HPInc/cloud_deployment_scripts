...
CLOUDWATCH_AGENT_SETUP_URL="https://s3.$REGION.amazonaws.com/amazoncloudwatch-agent-$REGION/ubuntu/amd64/latest/amazon-cloudwatch-agent.deb"
...
dpkg -i -E ./$(basename $CLOUDWATCH_AGENT_SETUP_URL)
