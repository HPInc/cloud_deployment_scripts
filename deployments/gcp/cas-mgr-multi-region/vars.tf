...
variable "dc_disk_image" {
  ...
  default     = "projects/windows-cloud/global/images/windows-server-2019-dc-v20210810"
}
...
variable "cac_disk_image" {
  ...
  default     = "projects/ubuntu-os-cloud/global/images/ubuntu-1804-bionic-v20210817"
}
...
variable "centos_gfx_disk_image" {
  ...
  default     = "projects/centos-cloud/global/images/centos-7-v20210817"
}
