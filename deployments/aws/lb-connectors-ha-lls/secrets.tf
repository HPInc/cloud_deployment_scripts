...
# This secret serves as a placeholder to pass a null value for the PCOIP reg code
# to the workstation modules.The expected Input to LLS Deployments is 
# a null value for PCOIP registration code.
